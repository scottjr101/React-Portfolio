              ...
              <div className='col-xl-4 col-lg-5'>
                <div className='featured-text text-center text-lg-left'>
                  ...
                  <p className='text-black-50 mb-0'>
                    Take a look at all of the projects I have had the pleasure
                    of being a part of. Each project includes a link to the
                    deployed site and the Github repository.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className='d-flex h-100'>
                    <div className='project-text w-100 my-auto text-center text-xl-left'>
                      ...
                      <p className='mb-3 text-white-50'>
                        ...
                        instant chat, video chat and more! You have the ability
                        to create an account with backend password encryption
                        and customize your own profile to share interesting
                        things about yourself.
                      </p>
                      <h6 className='text-white mb-3'>TECHNOLOGIES USED</h6>
                      <p className='mb-0 text-white-50'>
                        JSX, CSS, Bootstrap, Javascript, React.js, Redux,
                        Socket.io, MongoDB, Mongoose, JSON Web Tokens, Bcrypt,
                        and Node.js
                      </p>
